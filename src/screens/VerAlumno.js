...
const datos = [
  { id: '1', nombre: 'Maria Villanueva', acciones: 'Editar', imagen: require('../../assets/Usuario.png') },
  { id: '2', nombre: 'Nely Roríguez', acciones: 'Editar', imagen: require('../../assets/Usuario.png') },
